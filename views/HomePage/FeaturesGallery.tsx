...
const TABS = [
  ...
  },
  {
    ...
    description:
      '<p>платформа, обеспечивающая доступность образования через электронное обучение и дистанционные технологии, поддержку индивидуальных образовательных траекторий и поиск молодых талантов.</p>',
